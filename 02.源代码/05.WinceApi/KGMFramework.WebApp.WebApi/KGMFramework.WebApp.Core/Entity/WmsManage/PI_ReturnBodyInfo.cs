...
namespace KGMFramework.WebApp.Entity
{
    ...
    /// </summary>
    [DataContract]
    public class PI_ReturnBodyInfo : AppBaseEntity
    {
       
        /// <summary>
        /// 默认构造函数（需要初始化属性的在此处理）
        /// </summary>
        public PI_ReturnBodyInfo()
        {
        ...
        /// </summary>
        [DataMember]
        public virtual string F_InStockCode { get; set; }
        ...
        public System.Collections.Generic.List<PI_ReturnBodyInfo> Find(string p)
        {
