...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class Sys_OutRecords : BaseDALSQL<Sys_OutRecordsInfo>, ISys_OutRecords
	{
		#region 对象实例及构造函数

        public static Sys_OutRecords Instance
		{
			get
			{
                return new Sys_OutRecords();
			}
		}
        public Sys_OutRecords()
            : base("Sys_OutRecords", "F_Id")
		{
		}
        ...
        protected override Sys_OutRecordsInfo DataReaderToEntity(IDataReader dataReader)
        {
            Sys_OutRecordsInfo info = new Sys_OutRecordsInfo();
            SmartDataReader reader = new SmartDataReader(dataReader);

            info.F_HeadEnCode = reader.GetString("F_HeadEnCode");
            ...
            info.F_OutStockId = reader.GetString("F_OutStockId");
        ...
        protected override Hashtable GetHashByEntity(Sys_OutRecordsInfo obj)
        {
            Sys_OutRecordsInfo info = obj as Sys_OutRecordsInfo;
            Hashtable hash = new Hashtable();

      
            hash.Add("F_HeadEnCode", info.F_HeadEnCode);
            ...
            hash.Add("F_OutStockId", info.F_OutStockId);
