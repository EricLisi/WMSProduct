...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class Mst_CargoPosition : BaseDALSQL<Mst_CargoPositionInfo>, IMst_CargoPosition
	{
		#region 对象实例及构造函数

		public static Mst_CargoPosition Instance
		{
			get
			{
				return new Mst_CargoPosition();
			}
		}
        public Mst_CargoPosition()
            : base("Mst_CargoPosition", "F_Id")
		{
		}
        ...
        protected override Mst_CargoPositionInfo DataReaderToEntity(IDataReader dataReader)
        {
            ...
            info.F_Acreage = reader.GetString("F_Acreage");
            info.F_Unit = reader.GetString("F_Unit");
            info.F_Capacity = reader.GetString("F_Capacity");
             info.F_WhatIs = reader.GetString("F_WhatIs");
             info.F_SpecificatModel = reader.GetString("F_SpecificatModel");
            return info;
        }
        ...
        protected override Hashtable GetHashByEntity(Mst_CargoPositionInfo obj)
        {
            Mst_CargoPositionInfo info = obj as Mst_CargoPositionInfo;
            Hashtable hash = new Hashtable();
            hash.Add("F_WarehouseId", info.F_WarehouseId);
            hash.Add("F_Description", info.F_Description);
            hash.Add("F_SpecificatModel", info.F_SpecificatModel);
            hash.Add("F_WarehouseName", info.F_WarehouseName);
            hash.Add("F_Acreage", info.F_Acreage);
            ...
            hash.Add("F_Capacity", info.F_Capacity);
            hash.Add("F_WhatIs", info.F_WhatIs);
