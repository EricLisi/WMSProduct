...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class Sys_StockHistory : BaseDALSQL<Sys_StockHistoryInfo>, ISys_StockHistory
	{
		#region 对象实例及构造函数

        public static Sys_StockHistory Instance
		{
			get
			{
                return new Sys_StockHistory();
			}
		}
        public Sys_StockHistory()
            : base("Sys_StockHistory", "F_Id")
		{
		}
        ...
        protected override Sys_StockHistoryInfo DataReaderToEntity(IDataReader dataReader)
        {
            Sys_StockHistoryInfo info = new Sys_StockHistoryInfo();
            ...
            info.F_OperationNum = reader.GetInt32("F_OperationNum");
        ...
        protected override Hashtable GetHashByEntity(Sys_StockHistoryInfo obj)
        {
            Sys_StockHistoryInfo info = obj as Sys_StockHistoryInfo;
