...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class Sys_InRecords : BaseDALSQL<Sys_InRecordsInfo>, ISys_InRecords
	{
		#region 对象实例及构造函数

        public static Sys_InRecords Instance
		{
			get
			{
                return new Sys_InRecords();
			}
		}
        public Sys_InRecords()
            : base("Sys_InRecords", "F_Id")
		{
		}
        ...
        protected override Sys_InRecordsInfo DataReaderToEntity(IDataReader dataReader)
        {
            Sys_InRecordsInfo info = new Sys_InRecordsInfo();
        ...
        protected override Hashtable GetHashByEntity(Sys_InRecordsInfo obj)
        {
            Sys_InRecordsInfo info = obj as Sys_InRecordsInfo;
