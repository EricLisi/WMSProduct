...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 入库子表
    /// </summary>
    public class PI_Body : BaseDALSQL<PI_BodyInfo>, IPI_Body
    {
        #region 对象实例及构造函数

        public static PI_Body Instance
        {
            get
            {
                return new PI_Body();
        ...
        protected override PI_BodyInfo DataReaderToEntity(IDataReader dataReader)
        {
            PI_BodyInfo info = new PI_BodyInfo();
        ...
        protected override Hashtable GetHashByEntity(PI_BodyInfo obj)
        {
            PI_BodyInfo info = obj as PI_BodyInfo;
