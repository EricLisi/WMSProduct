...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 行政区域表
    /// </summary>
	public class Sys_Area : BaseDALSQL<Sys_AreaInfo>, ISys_Area
	{
		#region 对象实例及构造函数

		public static Sys_Area Instance
		{
			get
			{
				return new Sys_Area();
		...
		public Sys_Area() : base("Sys_Area","F_Id")
		{
		}
		...
		protected override Sys_AreaInfo DataReaderToEntity(IDataReader dataReader)
		{
			Sys_AreaInfo info = new Sys_AreaInfo();
        ...
        protected override Hashtable GetHashByEntity(Sys_AreaInfo obj)
		{
		    Sys_AreaInfo info = obj as Sys_AreaInfo;
