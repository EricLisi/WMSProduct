...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 模块表单
    /// </summary>
	public class Sys_ModuleForm : BaseDALSQL<Sys_ModuleFormInfo>, ISys_ModuleForm
	{
		#region 对象实例及构造函数

		public static Sys_ModuleForm Instance
		{
			get
			{
				return new Sys_ModuleForm();
			}
		}
		public Sys_ModuleForm() : base("Sys_ModuleForm","F_Id")
		{
		}
        ...
        protected override Hashtable GetHashByEntity(Sys_ModuleFormInfo obj)
		{
		    Sys_ModuleFormInfo info = obj as Sys_ModuleFormInfo;
			...
			hash.Add("F_Id", info.F_Id);
 			...
 			hash.Add("F_FormJson", info.F_FormJson);
