...
namespace KGMFramework.WebApp.Library
{
    public class ExcelHelper
    {
        ...
        //        ColumnEntity entity = excelConfig.ColumnEntity.Find(t => t.Column.ToUpper() == column.ColumnName.ToUpper());
        //        if (entity == null)
        //        {
        ...
        //        arrColWidth[item.Ordinal] = Encoding.GetEncoding(936).GetBytes(item.ColumnName.ToUpper()).Length;
        //        arrColName[item.Ordinal] = item.ColumnName.ToUpper();
        //        if (excelConfig.ColumnEntity != null)
        //        {
        //            ColumnEntity columnentity = excelConfig.ColumnEntity.Find(t => t.Column.ToUpper() == item.ColumnName.ToUpper());
        ...
        ///// <returns></returns>
        //public static DataTable ExcelImport(string strFileName, int readBeginRowIndex = 0, bool headTitle = true)
        //{
        ...
        //    IRow headerRow = sheet.GetRow(readBeginRowIndex);
        //    int cellCount = headerRow.LastCellNum;
        //    int beginIndex = (readBeginRowIndex + 1);//开始读取的行号
        ...
        //    for (int i = beginIndex; i <= sheet.LastRowNum; i++)
        //    {
