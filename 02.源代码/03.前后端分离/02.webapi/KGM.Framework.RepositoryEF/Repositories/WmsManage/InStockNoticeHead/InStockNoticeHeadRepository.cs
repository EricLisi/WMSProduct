...
{
    public class InStockNoticeHeadRepository : BaseRepository<InStockNoticeHeadEntity>, IInStockNoticeHeadRepository
    {
        /// <summary>
        /// 添加或修改入库通知单
        /// </summary>
        ...
        /// <returns></returns>
        public  GetResultModel InsUpdateInStockNotice(DataSet ds)
        {

            SqlParameter[] sqlParams = {
                new SqlParameter("PARM_SAVELIST_INSTOCKNOTICE_HEAD",ds.Tables[0]),
                new SqlParameter("PARM_SAVELIST_INSTOCKNOTICE_BODY",ds.Tables[1]),

            };
        
                var result = base.ExcuteStoredProcedureToList<GetResultModel>("[SAVELIST_INSTOCKNOTICE]", sqlParams).ToList();
        ...
        /// <param name="Id"></param>
        /// <returns></returns>
        public GetResultModel DeleteInStockNotice(string Id)
        {
                   SqlParameter[] sqlParams = {
                        new SqlParameter("@ID", Id),
                    };

            var result = base.ExcuteStoredProcedureToList<GetResultModel>("DELETE_PU", sqlParams).ToList();
        ...
        public GetResultModel VerifyList(string ID, string User, int orderType)
        {
            ...
            var result  = base.ExcuteStoredProcedureToList<GetResultModel>("[VERIFYLIST_PU]", sqlParams).ToList();
