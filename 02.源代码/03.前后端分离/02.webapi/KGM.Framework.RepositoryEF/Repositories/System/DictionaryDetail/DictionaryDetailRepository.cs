...
namespace KGM.Framework.RepositoryEF.Repositories
{
    ...
    /// 模块的仓储方法
    /// </summary>
    public class DictionaryDetailRepository : BaseRepository<DictionaryDetailEntity, DictionaryDetailContext>, IDictionaryDetailRepository
    {
        #region 构造函数
        /// <summary>
        /// 默认构造函数
        /// </summary>
        public DictionaryDetailRepository() : base()
        {
        }
        #endregion
        ...
        private DictionaryDetailEntity GetByKey(DictionaryDetailContext context, object key)
        {
        ...
        /// <param name="key"> 指定主键 </param>
        /// <returns> 符合编号的记录，不存在返回null </returns>
        public override DictionaryDetailEntity GetByKey(object key)
        {
        ...
        {
            using (var uow = new EFUnitOfWork<DictionaryDetailContext>(CurrentDbContext))
            {
