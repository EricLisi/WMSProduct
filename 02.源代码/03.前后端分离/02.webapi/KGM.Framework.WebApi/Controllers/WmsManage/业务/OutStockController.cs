...
namespace KGM.Framework.WebApi.Controllers
{
    ...
    {
        #region 依赖注入
        IOutStockHeadService _service;
        IOutStockBodyService _outStockBodyService;
        ...
        /// <param name="outStockBodyService"></param>
        /// <param name="customerService"></param>
        /// <param name="warehouseService"></param>
        /// <param name="productService"></param>
        /// <param name="ownerService"></param>
        /// <param name="strtypeService"></param>
        public OutStockController(IOutStockHeadService service, IOutStockBodyService outStockBodyService, ICustomerService customerService, IWarehouseService warehouseService, IInventoryService productService, IOwnerService ownerService, IReceiveTypeService strtypeService)
        {
            this._warehouseService = warehouseService;
            this._customerService = customerService;
            this._service = service;
            this._outStockBodyService = outStockBodyService;
        ...
        /// <returns></returns>
        [HttpPost, Route("")]
        public async Task<IActionResult> Add([FromBody]GetOutStockModel model)
        {
            return await Task.Run(() =>
            {
                var Message = _service.InsUpdateOutStock(GetTableData(model));
        ...
        /// <returns></returns>
        [HttpPut, Route("{Id}")]
        public async Task<IActionResult> Update([FromBody]GetOutStockModel model, string Id)
        {
            return await Task.Run(() =>
            {
                model.info.Id = Id;
        ...
        public async Task<IActionResult> Delete(string Id)
        {
            return await Task.Run(() =>
            {
                ReturnModel model = _service.DeleteOutStock(Id);
        ...
        public async Task<IActionResult> GetById(string Id)
        {
            ...
            var Dinfo = await _outStockBodyService.QueryAsync(u => u.OrderNo == Info.OrderNo);
        ...
        public async Task<IActionResult> GatPagerListByWhere(string keyword, int rows, int page, string sidx, string sord, string Id)
        {
            ...
            PagerEntity<OutStockHeadGetDto> entity = await _service.QueryByPagesAsync(rows, page,
                      t => t.OrderNo.Contains((keyword ?? t.OrderNo)) ,
                      _service.Expression(sidx), sord.ToUpper().Equals("ASC"));

            List<OutStockHeadGetDto> list = await _service.QueryAsync();
        ...
        /// <returns></returns>
        public static DataSet GetTableData(GetOutStockModel model)
        {
            DataSet ds = GetData();
