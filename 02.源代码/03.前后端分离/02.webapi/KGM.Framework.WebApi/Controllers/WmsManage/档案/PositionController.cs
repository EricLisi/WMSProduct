...
namespace KGM.Framework.WebApi.Controllers
{
    ...
    /// 货位管理接口
    /// </summary>  
    public class PositionController : Base.AppBaseController
    {
        #region 依赖注入
        ...
        {
            return Ok(await _service.QueryByIdAsync<PositionSingleDto>(Id));
        }
        ...
        /// <returns></returns>
        [HttpGet, Route("QueryPositionByPagers")]
        public async Task<IActionResult> QueryPositionByPagers([FromQuery]PositionIndexCondition condition)
        {
            //设置分页对象
        ...
        /// 新增货位
        /// </summary>
        /// <param name="entity">货位对象</param>
        /// <returns></returns>
        [HttpPost]
        public async Task<IActionResult> Insert([FromBody]PositionSingleDto entity)
        {
            try
            {
        ...
        /// <returns></returns>
        [HttpPut, Route("{Id}")]
        public async Task<IActionResult> Update(string Id, [FromBody]PositionSingleDto entity)
        {
            try
            {
                entity.Id = Id;
