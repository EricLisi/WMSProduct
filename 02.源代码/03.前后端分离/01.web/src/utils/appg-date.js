/*
 * 版 本 Learun-ADMS V7.0.0 力软 敏捷开发框架(http://www.app.cn)
...
(function ($, app) {
    ...
    $.extend(app, {
        ...
        getDate: function (format, strInterval, Number) {
            ...
            var res = app.formatDate(myDate, format);
            return res;
        },
        // 月
        getMonth:function(){
            ...
            var currentDate = app.parseDate(app.formatDate(new Date(), "yyyy-MM-01"));
            var endDate = currentDate.DateAdd('m', 1).DateAdd('d', -1);

            res.begin = app.formatDate(currentDate, 'yyyy-MM-dd 00:00:00');
            res.end = app.formatDate(endDate, 'yyyy-MM-dd 23:59:59');
        ...
        getPreMonth: function () {
            ...
            res.begin = app.formatDate(preMonth, 'yyyy-MM-01 00:00:00');
            res.end = app.formatDate(preMonth, 'yyyy-MM-dd 23:59:59');
        ...
        getCurrentQuarter: function () {
            ...
            return app.getQuarter(currentDate.getFullYear(), currentDate.getMonth());
        },
