...
searchSetting = {//查询设置
    setPostData: function () {
        return { keyword: $("#txt_keyword").val(), searchFiled: "F_EnCode/F_InStockCode/F_Maker" };
    }
},
gridSetting = {//列表设置对象
    ...
    colModel: [
        ...
        { label: '退货原因', name: 'F_Description', width: 200, align: 'left' }]//grid的显示列
},
...
var Document = function () {
    return {
        bVerify: function (key, title, state) {// 单据3种状态 0 待打印标签 1 已打印标签待审核 2 已审核
            ...
            var info = false
            $.ajax({
                url: "/WmsManage/PurchaseInStock/GetFormJson1?keyValue=" + key,
                type: "get",
                dataType: "json",
                async: false,
