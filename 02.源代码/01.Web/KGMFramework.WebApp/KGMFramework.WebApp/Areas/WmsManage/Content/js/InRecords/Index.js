...
var router = "/WmsManage/InRecords",                            //当前页面路由 
    searchSetting = {                                           //查询设置
        setPostData: function () {
            return { keyword: $("#txt_keyword").val(), searchFiled: "F_Batch/F_GoodsName/F_WarehouseName" };
        }
    },
    gridSetting = {                                             //列表设置对象
        ...
        colModel: [
            ...
            { label: "入库单据", name: "F_EnCode", width: 150, align: 'left' },
            ...
            {
                label: '入库时间', name: 'F_CreatorTime', width: 80, align: 'left',
                formatter: "date",
