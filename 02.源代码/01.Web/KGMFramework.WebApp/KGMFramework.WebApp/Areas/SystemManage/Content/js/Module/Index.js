...
gridSetting = {                                             //列表设置对象
    ...
    //colModelUrl: GetGridColumns({
    //    page: "/SystemManage/Module",//页面Url
    //    gridId: "gridList",//表格Id
    //}),// "/Areas/SystemManage/Content/js/Module/Index_gridList.js",
    searchActionUrl: router + '/GetTreeGridJson',//查询API
    //colModel: GetGridColumns({ page: "/SystemManage/Module" })
    colModel: [
