...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 终端列表显示设置
    /// </summary>
	public class Sys_TerminalListSetting : BaseDALSQL<Sys_TerminalListSettingInfo>, ISys_TerminalListSetting
	{
		#region 对象实例及构造函数

		public static Sys_TerminalListSetting Instance
		{
			get
			{
				return new Sys_TerminalListSetting();
			}
		}
		public Sys_TerminalListSetting() : base("Sys_TerminalListSetting","F_Id")
		{
		}
		...
		protected override Sys_TerminalListSettingInfo DataReaderToEntity(IDataReader dataReader)
		{
			Sys_TerminalListSettingInfo info = new Sys_TerminalListSettingInfo();
			...
			info.F_Display = reader.GetString("F_Display");
			info.F_Type = reader.GetString("F_Type");
			info.F_Address = reader.GetString("F_Address");
			info.F_Required = reader.GetBoolean("F_Required");
        ...
        protected override Hashtable GetHashByEntity(Sys_TerminalListSettingInfo obj)
		{
		    Sys_TerminalListSettingInfo info = obj as Sys_TerminalListSettingInfo;
			...
			hash.Add("F_Id", info.F_Id);
 			...
 			hash.Add("F_Display", info.F_Display);
 			hash.Add("F_Type", info.F_Type);
 			hash.Add("F_Address", info.F_Address);
 			hash.Add("F_Required", info.F_Required);
        ...
        public override Dictionary<string, string> GetColumnNameAlias()
        {
            ...
            dict.Add("F_Id", "主键");
             ...
             dict.Add("F_ParentId", "父节点ID（是哪个菜单）");
             dict.Add("F_Display", "显示值");
             dict.Add("F_Type", "文本框类型");
             dict.Add("F_Address", "API方法地址");
             dict.Add("F_Required", "是否必填");
