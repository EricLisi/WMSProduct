...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class Sys_OutReturn : BaseDALSQL<Sys_OutReturnInfo>, ISys_OutReturn
	{
		#region 对象实例及构造函数

        public static Sys_OutReturn Instance
		{
			get
			{
                return new Sys_OutReturn();
			}
		}
        public Sys_OutReturn()
            : base("Sys_OutReturn", "F_Id")
		{
		}
        ...
        protected override Sys_OutReturnInfo DataReaderToEntity(IDataReader dataReader)
        {
            Sys_OutReturnInfo info = new Sys_OutReturnInfo();
        ...
        protected override Hashtable GetHashByEntity(Sys_OutReturnInfo obj)
        {
            Sys_OutReturnInfo info = obj as Sys_OutReturnInfo;
            ...
            hash.Add("F_TradePrice", info.F_OutStockNum);
