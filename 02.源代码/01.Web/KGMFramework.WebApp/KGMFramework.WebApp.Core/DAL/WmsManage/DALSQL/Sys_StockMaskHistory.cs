...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class Sys_StockMaskHistory : BaseDALSQL<Sys_StockMaskHistoryInfo>, ISys_StockMaskHistory
    {
        #region 对象实例及构造函数

        public static Sys_StockMaskHistory Instance
        {
            get
            {
                return new Sys_StockMaskHistory();
            }
        }
        public Sys_StockMaskHistory()
            : base("Sys_StockMaskHistory", "F_Id")
        {
        }
        ...
        protected override Sys_StockMaskHistoryInfo DataReaderToEntity(IDataReader dataReader)
        {
            Sys_StockMaskHistoryInfo info = new Sys_StockMaskHistoryInfo();
            ...
            info.F_GoodsCode = reader.GetString("F_GoodsCode");
        ...
        protected override Hashtable GetHashByEntity(Sys_StockMaskHistoryInfo obj)
        {
            Sys_StockMaskHistoryInfo info = obj as Sys_StockMaskHistoryInfo;
            Hashtable hash = new Hashtable();

            hash.Add("F_GoodsId", info.F_GoodsId);
            hash.Add("F_GoodsCode", info.F_GoodsCode);
