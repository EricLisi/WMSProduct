...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 资产调拨子表
    /// </summary>
    public class Mst_Category : BaseDALSQL<Mst_CategoryInfo>,IMst_Category
	{
		#region 对象实例及构造函数

		public static Mst_Category Instance
		{
			get
			{
				return new Mst_Category();
			}
		}
        public Mst_Category()
            : base("Mst_Category", "F_Id")
		{
		}
        ...
        protected override Mst_CategoryInfo DataReaderToEntity(IDataReader dataReader)
        {
            Mst_CategoryInfo info = new Mst_CategoryInfo();
        ...
        protected override Hashtable GetHashByEntity(Mst_CategoryInfo obj)
        {
            Mst_CategoryInfo info = obj as Mst_CategoryInfo;
        ...
        public override Dictionary<string, string> GetColumnNameAlias()
        {
            ...
            #region 添加别名解析
            dict.Add("F_Id", "主键");
            dict.Add("F_EnCode", "类型编码");
            dict.Add("F_FullName", "类型名称");
