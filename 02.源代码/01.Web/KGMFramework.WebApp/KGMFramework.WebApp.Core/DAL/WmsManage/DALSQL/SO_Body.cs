...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class SO_Body : BaseDALSQL<SO_BodyInfo>, ISO_Body
    {
        #region 对象实例及构造函数

        public static SO_Body Instance
        {
            get
            {
                return new SO_Body();
        ...
        protected override SO_BodyInfo DataReaderToEntity(IDataReader dataReader)
        {
            SO_BodyInfo info = new SO_BodyInfo();
        ...
        protected override Hashtable GetHashByEntity(SO_BodyInfo obj)
        {
            SO_BodyInfo info = obj as SO_BodyInfo;
