...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 货位表
    /// </summary>
    public class Mst_CusterCategory : BaseDALSQL<Mst_CusterCategoryInfo>, IMst_CusterCategory
    {
        #region 对象实例及构造函数
        ...
        public Mst_CusterCategory()
            : base("Mst_CusterCategory", "F_Id")
        {
        }
        ...
        protected override Mst_CusterCategoryInfo DataReaderToEntity(IDataReader dataReader)
        {
            Mst_CusterCategoryInfo info = new Mst_CusterCategoryInfo();
        ...
        protected override Hashtable GetHashByEntity(Mst_CusterCategoryInfo obj)
        {
            Mst_CusterCategoryInfo info = obj as Mst_CusterCategoryInfo;
