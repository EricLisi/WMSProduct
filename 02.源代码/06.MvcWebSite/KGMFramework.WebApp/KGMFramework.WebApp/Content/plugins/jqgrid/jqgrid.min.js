    ...
    $.fn.jqGrid = function (pin) {
        ...
        return this.each(function () {
            ...
            for (i = 0; i < this.p.colNames.length; i++) {
                ...
                if (ts.p.colModel[i] && ts.p.colModel[i].batchedit) {//启用批量编辑
                    var edithtml = "";
                    var _defaultBatchEdit = {
                        title: "批量编辑",
                        inputmodel: "input",
                        inputdataurl: "",//
                        callback: undefined
                    ...
                    ts.p.colModel[i].batcheditopts = $.extend(_defaultBatchEdit, ts.p.colModel[i].batcheditopts)
                    var batcheditid = 'jqgh_' + ts.p.id + "_" + tmpcm.name + '_batchEdit';
                    thead += '<a id="' + batcheditid + '" href="#" class="batchedit" inputFiled="' + ts.p.colModel[i].batcheditopts.inputFiled + '" inputdataurl="' + ts.p.colModel[i].batcheditopts.inputdataurl + '" inputmodel="' + ts.p.colModel[i].batcheditopts.inputmodel + '" inputtitle="' + ts.p.colModel[i].batcheditopts.title + '" onclick="' + ts.p.colModel[i].batcheditopts.callback + '(' + batcheditid + ')"><i class="fa fa-pencil-square-o"></i></a>'
                }
