...
$(function ($) {
    $("#content-wrapper").find('.mainContent').height($(window).height() - 110);
...
function GetLoadNav() {
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    if (subChildNodes.length > 0) {
                        _html += '<a class="dropdown-toggle" data-id="' + subrow.F_Id + '" href="#"><i class="' + subrow.F_Icon + '"></i><span>' + subrow.F_FullName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
                        _html += '<ul class="submenu">';
                        $.each(subChildNodes, function (i) {
                            var subrow1 = subChildNodes[i];
                            _html += '<li>';
                            _html += '<a class="menuItem" data-id="' + subrow1.F_Id + '" href="' + subrow1.F_UrlAddress + '" data-index="' + subrow1.F_SortCode + '"><i class="' + subrow1.F_Icon + '"></i><span>' + subrow1.F_FullName + '</span></a>';
                            _html += '</li>';
                        });
                        _html += '</ul>';
                    }
    ...
    setTimeout(function () {
        $("#app-menudata .menuItem").click(function () {
            $("#appmenu-dialog").hide();
            show = false;
        })
    }, 1000)
