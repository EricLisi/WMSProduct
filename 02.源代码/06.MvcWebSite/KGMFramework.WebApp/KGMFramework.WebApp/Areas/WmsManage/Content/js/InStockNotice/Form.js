        ...
        bindVerify: function () {//审核单据
            $("#NF-verify").click(function () {
                $.modalConfirm("注：您确定要审核单据吗？", function (r) {
                    if (r) {
                        $.ajax({
                            url: "/WmsManage/InStockNotice/Verify?keyValue=" + keyValue,
                            type: "get",
                            dataType: "json",
                            async: false,
                            success: function (result) {
        ...
        bindDeny: function () {//弃审单据
            $("#NF-deny").click(function () {
                $.modalConfirm("注：您确定要弃审单据吗？", function (r) {
                    if (r) {
                        $.ajax({
                            url: "/WmsManage/InStockNotice/DenyVerify?keyValue=" + keyValue,
                            type: "get",
                            dataType: "json",
                            async: false,
                            success: function (result) {
    ...
    grid: {//grid对象 
        ...
        options: {//参数
            ...
            colModel: [
                    ...
                    {
                        label: '入库仓库', name: 'F_WarehouseId', index: 'F_WarehouseId', width: 150, sortable: false,
                    ...
                    {
                        label: '入库货位', name: 'F_PositionId', index: 'F_PositionId', width: 150, sortable: false,
                        //editable: true, edittype: 'select',
                        //editoptions: {
                        //    value: form.Mst.PositionSelectData
                        //}
                    },
                    { label: '已入库数量', name: 'F_DoneQty', width: 100, align: 'left' }
            ]//grid的显示列
