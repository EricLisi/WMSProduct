...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 入库单子表
    /// </summary>
	public class InStock_Body : BaseDALSQL<InStock_BodyInfo>, IInStock_Body
	{
		#region 对象实例及构造函数

		public static InStock_Body Instance
		{
			get
			{
				return new InStock_Body();
			}
		}
		public InStock_Body() : base("InStock_Body","F_Id")
		{
		}
		...
		protected override InStock_BodyInfo DataReaderToEntity(IDataReader dataReader)
		{
			InStock_BodyInfo info = new InStock_BodyInfo();
        ...
        protected override Hashtable GetHashByEntity(InStock_BodyInfo obj)
		{
		    InStock_BodyInfo info = obj as InStock_BodyInfo;
