...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 出库单子表
    /// </summary>
	public class OutStock_Body : BaseDALSQL<OutStock_BodyInfo>, IOutStock_Body
	{
		#region 对象实例及构造函数

		public static OutStock_Body Instance
		{
			get
			{
				return new OutStock_Body();
			}
		}
		public OutStock_Body() : base("OutStock_Body","F_Id")
		{
		}
		...
		protected override OutStock_BodyInfo DataReaderToEntity(IDataReader dataReader)
		{
			OutStock_BodyInfo info = new OutStock_BodyInfo();
        ...
        protected override Hashtable GetHashByEntity(OutStock_BodyInfo obj)
		{
		    OutStock_BodyInfo info = obj as OutStock_BodyInfo;
