...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 出库通知单子表
    /// </summary>
	public class OutStockNotice_Body : BaseDALSQL<OutStockNotice_BodyInfo>, IOutStockNotice_Body
	{
		#region 对象实例及构造函数

		public static OutStockNotice_Body Instance
		{
			get
			{
				return new OutStockNotice_Body();
			}
		}
		public OutStockNotice_Body() : base("OutStockNotice_Body","F_Id")
		{
		}
		...
		protected override OutStockNotice_BodyInfo DataReaderToEntity(IDataReader dataReader)
		{
			OutStockNotice_BodyInfo info = new OutStockNotice_BodyInfo();
			...
			info.F_PickQty = reader.GetDecimal("F_PickQty");
        ...
        protected override Hashtable GetHashByEntity(OutStockNotice_BodyInfo obj)
		{
		    OutStockNotice_BodyInfo info = obj as OutStockNotice_BodyInfo;
			...
			hash.Add("F_Id", info.F_Id);
 			...
 			hash.Add("F_PickQty", info.F_PickQty);
        ...
        public override Dictionary<string, string> GetColumnNameAlias()
        {
            ...
            dict.Add("F_Id", "主键");
             ...
             dict.Add("F_DoneQty", "出库数量");
             dict.Add("F_PickQty", "拣货数量");
