...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 商品视图信息表
    /// </summary>
	public class V_PACKLISTBODYSEL : BaseDALSQL<V_PACKLISTBODYSELInfo>, IV_PACKLISTBODYSEL	{
		#region 对象实例及构造函数

		public static V_PACKLISTBODYSEL Instance
		{
			get
			{
				return new V_PACKLISTBODYSEL();
			}
		}
		public V_PACKLISTBODYSEL() : base("V_PACKLISTBODYSEL", "F_Id")
		{
		}
		...
		protected override V_PACKLISTBODYSELInfo DataReaderToEntity(IDataReader dataReader)
		{
            V_PACKLISTBODYSELInfo info = new V_PACKLISTBODYSELInfo();
        ...
        protected override Hashtable GetHashByEntity(V_PACKLISTBODYSELInfo obj)
		{
            V_PACKLISTBODYSELInfo info = obj as V_PACKLISTBODYSELInfo;
