...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 供应商信息表
    /// </summary>
	public class Mst_Supplier : BaseDALSQL<Mst_SupplierInfo>, IMst_Supplier
	{
		#region 对象实例及构造函数

		public static Mst_Supplier Instance
		{
			get
			{
				return new Mst_Supplier();
			}
		}
		public Mst_Supplier() : base("Mst_Supplier","F_Id")
		{
		}
		...
		protected override Mst_SupplierInfo DataReaderToEntity(IDataReader dataReader)
		{
			Mst_SupplierInfo info = new Mst_SupplierInfo();
        ...
        protected override Hashtable GetHashByEntity(Mst_SupplierInfo obj)
		{
		    Mst_SupplierInfo info = obj as Mst_SupplierInfo;
        ...
        public override Dictionary<string, string> GetColumnNameAlias()
        {
            ...
            //dict.Add("ID", "编号");
            dict.Add("F_Id", "主键");
             dict.Add("F_EnCode", "供应商编号");
             dict.Add("F_FullName", "供应商名称");
             dict.Add("F_OrganizationId", "所属机构Id");
             dict.Add("F_ClassId", "供应商分类Id");
