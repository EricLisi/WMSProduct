...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 出库通知单主表
    /// </summary>
	public class OutStockNotice_Head : BaseDALSQL<OutStockNotice_HeadInfo>, IOutStockNotice_Head
	{
		#region 对象实例及构造函数

		public static OutStockNotice_Head Instance
		{
			get
			{
				return new OutStockNotice_Head();
			}
		}
		public OutStockNotice_Head() : base("OutStockNotice_Head","F_Id")
		{
		}
		...
		protected override OutStockNotice_HeadInfo DataReaderToEntity(IDataReader dataReader)
		{
			OutStockNotice_HeadInfo info = new OutStockNotice_HeadInfo();
        ...
        protected override Hashtable GetHashByEntity(OutStockNotice_HeadInfo obj)
		{
		    OutStockNotice_HeadInfo info = obj as OutStockNotice_HeadInfo;
