...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 出库单主表
    /// </summary>
	public class OutStock_Head : BaseDALSQL<OutStock_HeadInfo>, IOutStock_Head
	{
		#region 对象实例及构造函数

		public static OutStock_Head Instance
		{
			get
			{
				return new OutStock_Head();
			}
		}
		public OutStock_Head() : base("OutStock_Head","F_Id")
		{
		}
		...
		protected override OutStock_HeadInfo DataReaderToEntity(IDataReader dataReader)
		{
			OutStock_HeadInfo info = new OutStock_HeadInfo();
        ...
        protected override Hashtable GetHashByEntity(OutStock_HeadInfo obj)
		{
		    OutStock_HeadInfo info = obj as OutStock_HeadInfo;
