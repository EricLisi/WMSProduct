...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 现存量预占表
    /// </summary>
	public class Sm_CompOnStock : BaseDALSQL<Sm_CompOnStockInfo>, ISm_CompOnStock
	{
		#region 对象实例及构造函数

		public static Sm_CompOnStock Instance
		{
			get
			{
				return new Sm_CompOnStock();
			}
		}
		public Sm_CompOnStock() : base("Sm_CompOnStock","F_Id")
		{
		}
		...
		protected override Sm_CompOnStockInfo DataReaderToEntity(IDataReader dataReader)
		{
			Sm_CompOnStockInfo info = new Sm_CompOnStockInfo();
        ...
        protected override Hashtable GetHashByEntity(Sm_CompOnStockInfo obj)
		{
		    Sm_CompOnStockInfo info = obj as Sm_CompOnStockInfo;
