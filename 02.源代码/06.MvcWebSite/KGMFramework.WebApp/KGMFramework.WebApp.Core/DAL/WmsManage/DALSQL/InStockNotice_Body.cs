...
namespace KGMFramework.WebApp.DALSQL
{
    ...
    /// 入库单通知单子表
    /// </summary>
	public class InStockNotice_Body : BaseDALSQL<InStockNotice_BodyInfo>, IInStockNotice_Body
	{
		#region 对象实例及构造函数

		public static InStockNotice_Body Instance
		{
			get
			{
				return new InStockNotice_Body();
			}
		}
		public InStockNotice_Body() : base("InStockNotice_Body","F_Id")
		{
		}
		...
		protected override InStockNotice_BodyInfo DataReaderToEntity(IDataReader dataReader)
		{
			InStockNotice_BodyInfo info = new InStockNotice_BodyInfo();
        ...
        protected override Hashtable GetHashByEntity(InStockNotice_BodyInfo obj)
		{
		    InStockNotice_BodyInfo info = obj as InStockNotice_BodyInfo;
